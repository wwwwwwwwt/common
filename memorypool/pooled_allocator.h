/*
 * @Author: zzzzztw
 * @Date: 2023-04-19 13:28:42
 * @LastEditors: Do not edit
 * @LastEditTime: 2023-04-19 14:48:52
 * @FilePath: /myLearning/memorypool/pooled_allocator.h
 */
...
struct pooled_allocator : private Base {
    ...
    /*
        1. 对单个对象的内存分配和释放使用线程内存池，适合list，map， set，不适用于vector，queue批量分配内存的容器
    */
